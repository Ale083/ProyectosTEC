...
public:
    Robot2Thread();
    Robot2Thread(QString id, cola<Monstruo*>* colaRobot2, QCheckBox* checkBoxRobot2, QSpinBox* sbxProbaRobot2, Lista<Monstruo*>* listaAlmacen, Lista<Monstruo*>* basureroDeMonstruos, QMutex* mutexColaRobot2, QMutex* mutexListaAlmacen) {
        this->id = id;
